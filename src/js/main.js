...
function init () {
  ...
  var SiteWide = (function () {
    ...
    */
    ...
    var _getCurrentPanel = function () {
      var sections = $('#main-wrap').find('section')
    ...
    var _initPanelSnap = function () {
      ...
      if (!container.hasClass('js-disable-panel-snap')) {
  ...
  /*===========================================================================
    Culture Page Module: 
    Modified by DA 6/12/2017
     - removed functions relating to previous page's SVGs
  ===========================================================================*/

  var CulturePage = (function () {

    // var _addDudeOnBeachSVG = function () {
    //   var svgEl = Snap('#dude-svg')
    //   Snap.load('/img/culture/dude.svg', function (f) {
    //     var dude = f.select('#dude')
    //     svgEl.append(dude)
    //   })
    // }

    // var _addClouds = function () {
    //   var svgEl = Snap('#clouds-svg')
    //   Snap.load('/img/culture/beach-clouds.svg', function (f) {
    //     var trustCloud = f.select('#trust-cloud')
    ...
    //     svgEl.append(accountabilityCloud)
    //   })
    // }

    // var _initBeachSVG = function () {
    //   _addDudeOnBeachSVG()
    //   _addClouds()
    // }
    ...
    //   _initPicnicLadySVG()
    //   _initPicnicWheelSVG()
    //   _initPicnicBlanketSVG()
    //   _initPicnicDudeSVG()
    //   _initPicnicBBQSVG()
    //   _initPicnicBabySVG()
    // }

    // var _initPicnicLadySVG = function () {
    //   var svgEl = Snap('#picnic-lady-svg')
    //   Snap.load('/img/culture/picnic-lady.svg', function (f) {
    //     var lady = f.select('#lady')
    //     svgEl.append(lady)
    //   })
    // }

    // var _initPicnicWheelSVG = function () {
    //   var svgEl = Snap('#picnic-wheel-svg')
    //   Snap.load('/img/culture/picnic-wheel.svg', function (f) {
    //     var wheel = f.select('#wheel')
    //     svgEl.append(wheel)
    //   })
    // }

    // var _initPicnicBlanketSVG = function () {
    //   var svgEl = Snap('#picnic-blanket-svg')
    //   Snap.load('/img/culture/picnic-blanket.svg', function (f) {
    //     var blanket = f.select('#blanket')
    //     svgEl.append(blanket)
    //   })
    // }

    // var _initPicnicDudeSVG = function () {
    //   var svgEl = Snap('#picnic-dude-svg')
    //   Snap.load('/img/culture/picnic-dude.svg', function (f) {
    //     var dude = f.select('#picnic-dude')
    //     svgEl.append(dude)
    //   })
    // }

    // var _initPicnicBBQSVG = function () {
    //   var svgEl = Snap('#picnic-bbq-svg')
    //   Snap.load('/img/culture/picnic-bbq.svg', function (f) {
    //     var bbq = f.select('#bbq')
    //     svgEl.append(bbq)
    //   })
    // }

    // var _initPicnicBabySVG = function () {
    //   var svgEl = Snap('#picnic-baby-svg')
    //   Snap.load('/img/culture/picnic-baby.svg', function (f) {
    //     var baby = f.select('#baby')
    //     svgEl.append(baby)
    //   })
    // }

    // var _initMountainSVG = function () {
    //   var svgEl = Snap('#mountain-svg')
    //   Snap.load('/img/culture/mountain.svg', function (f) {
    //     var mountain = f.select('#mountain')
    //     svgEl.append(mountain)
    //   })
    // }
  ...
  if (main.length) {
    ...
    // Culture page initialisation:
    //if (main.hasClass('culture-page')) CulturePage.init()
